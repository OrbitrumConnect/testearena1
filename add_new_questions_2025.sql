...
((SELECT id FROM public.eras WHERE slug = 'egito-antigo'), 'religion', 'qa', 'Gatos Sagrados do Egito', 'Os gatos eram considerados animais sagrados no Egito, associados à deusa Bastet e frequentemente mumificados.', 'Qual animal era sagrado no Egito Antigo?', 'Gato', '["Cavalo", "Lobo", "Serpente"]', ARRAY['gatos', 'bastet', 'sagrado'], true),
...
((SELECT id FROM public.eras WHERE slug = 'era-digital'), 'security', 'qa', 'Phishing Digital', 'Phishing é um golpe digital que usa emails, sites e mensagens falsas para roubar informações pessoais e senhas.', 'O que é phishing?', 'Golpe digital que rouba informações', '["Técnica de segurança digital", "Software de edição de imagens", "Protocolo de rede"]', ARRAY['phishing', 'golpe', 'segurança'], true),

((SELECT id FROM public.eras WHERE slug = 'era-digital'), 'social', 'qa', 'TikTok Videos Curtos', 'TikTok foi a rede social que popularizou os vídeos curtos, mudando como consumimos conteúdo digital.', 'Qual rede social surgiu focada em vídeos curtos?', 'TikTok', '["Twitter", "LinkedIn", "Facebook"]', ARRAY['tiktok', 'vídeos-curtos', 'social'], true),
...
((SELECT id FROM public.eras WHERE slug = 'era-digital'), 'security', 'qa', 'Ransomware Malware', 'Ransomware é um malware que criptografa arquivos da vítima e exige pagamento para liberar o acesso.', 'O que é ransomware?', 'Programa que bloqueia dados até pagamento', '["Sistema de backup automático", "Aplicativo de streaming", "Antivírus gratuito"]', ARRAY['ransomware', 'malware', 'resgate'], true),
...
((SELECT id FROM public.eras WHERE slug = 'era-digital'), 'security', 'qa', 'Autenticação 2FA', '2FA (Two-Factor Authentication) é um sistema de segurança que exige duas formas diferentes de verificação de identidade.', 'O que significa 2FA (autenticação de dois fatores)?', 'Segurança que exige duas formas de verificação', '["Sistema de criptografia de arquivos", "Programa de criação de senhas", "Protocolo de rede"]', ARRAY['2fa', 'autenticação', 'segurança'], true),
