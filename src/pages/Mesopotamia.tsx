          ...
          <div className="flex items-center justify-between px-8 mb-6">
            ...
            <div className="text-center">
              ...
              <div className="arena-card backdrop-blur-sm bg-victory/20 p-3 min-w-32">
                ...
                <div className="text-xs text-muted-foreground">Escriba</div>
            ...
            {/* Timer */}
            <div className="arena-card-epic backdrop-blur-sm bg-amber-500/20 p-4 text-center border-2 border-amber-500 glow-epic mx-4">
              <div className="text-3xl mb-1">⏳</div>
              <div className={`text-2xl font-bold ${timeLeft <= 10 ? 'text-destructive animate-pulse' : 'text-amber-400'}`}>
                {timeLeft}s
              </div>
            </div>
            ...
            <div className="text-center">
              ...
              <div className="arena-card backdrop-blur-sm bg-destructive/20 p-3 min-w-32">
                <h3 className="font-montserrat font-bold text-sm text-destructive">TOURO ALADO</h3>
