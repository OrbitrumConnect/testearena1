  ...
  return (
    <div className={`${isMobile ? 'h-screen overflow-hidden' : 'h-screen overflow-hidden'} bg-background relative`}>
      ...
      <div className={`relative z-10 max-w-4xl mx-auto ${isMobile ? 'p-1 h-screen overflow-y-auto w-full' : 'p-6'}`} style={isMobile ? {transform: 'translate(-4.5%, -5%)'} : {}}>
        ...
        {/* Pergunta */}
        <div className={`arena-card-epic backdrop-blur-sm bg-amber-500/10 border border-amber-500 ${isMobile ? 'p-1 mb-2 mx-1 w-9/10' : 'p-1 mb-2 mt-10 border-2 glow-epic scale-75'}`} style={isMobile ? {marginTop: '32%', width: '90%', marginLeft: 'auto', marginRight: 'auto', transform: 'scale(0.6)'} : {marginTop: '33%', width: '140%', marginLeft: '-20%', marginRight: '-20%'}}>
