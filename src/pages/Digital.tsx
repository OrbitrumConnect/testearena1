      ...
      <div className="relative z-10 max-w-4xl mx-auto p-6">
        ...
        <div className="flex items-center justify-between mb-8">
          ...
          <div className="text-center arena-card-epic backdrop-blur-sm bg-card/80 px-6 py-3">
            <h1 className="text-2xl font-montserrat font-bold text-epic">🤖 BATALHA DIGITAL</h1>
            <p className="text-muted-foreground">Era da Tecnologia - {currentQuestion + 1}/{questions.length}</p>
          </div>
