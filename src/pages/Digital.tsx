             ...
             return (
               ...
               >
                 {laserSize}
                                    ...
                                    {/* Pergunta */}
                   <div className="arena-card-epic backdrop-blur-sm bg-cyan-500/10 border border-cyan-500 p-0.5 mb-0.5 mx-1 w-9/10 md:p-0.5 md:mb-0.5 md:mt-0.5 md:border-2 md:glow-epic md:scale-100 md:w-1/5 md:mx-auto" style={{marginTop: isMobile ? '-5%' : '5%', width: '39%', height: '28%', marginLeft: 'auto', marginRight: 'auto'}}>
