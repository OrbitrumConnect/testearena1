  ...
  return (
    <div className={`${isMobile ? 'h-screen overflow-hidden' : 'h-screen overflow-hidden'} bg-background relative`}>
      ...
      <div className={`relative z-10 max-w-4xl mx-auto ${isMobile ? 'p-1 h-screen overflow-y-auto w-full' : 'p-6'}`} style={isMobile ? {transform: 'translate(-4.5%, -5%)'} : {}}>
        ...
        {/* Pergunta */}
        <div className={`arena-card-epic backdrop-blur-sm bg-cyan-500/10 border border-cyan-500 digital-question-card ${isMobile ? 'p-2 mb-3 mx-2 w-11/12' : 'p-2 mb-2 mt-10 border-2 glow-epic scale-56'}`} style={isMobile ? {marginTop: '5%', width: '92%', marginLeft: 'auto', marginRight: 'auto'} : {}}>
