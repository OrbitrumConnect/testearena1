...
((SELECT id FROM public.eras WHERE slug = 'egito-antigo'), 'finance', 'qa', 'Renda dos Faraós', 'Os faraós obtinham renda através de tributos de agricultores, comerciantes e impostos sobre todos os produtos e atividades econômicas do reino.', 'Qual era a fonte de renda dos faraós?', 'Tributos de agricultores, comerciantes e impostos sobre produtos', '["Produção artesanal", "Pesca", "Apenas mineração"]', ARRAY['faraós', 'tributos', 'impostos'], true),

((SELECT id FROM public.eras WHERE slug = 'egito-antigo'), 'finance', 'qa', 'Comércio Internacional', 'Os comerciantes egípcios lucravam com o comércio internacional vendendo papiro, ouro e tecidos de linho para povos do Mediterrâneo e África.', 'Como os comerciantes do Egito lucravam com o comércio internacional?', 'Vendendo papiro, ouro e tecidos para outros povos', '["Lutando com mercenários", "Produzindo vinho apenas para templos", "Construindo navios militares"]', ARRAY['comércio-internacional', 'papiro', 'ouro'], true),

((SELECT id FROM public.eras WHERE slug = 'egito-antigo'), 'finance', 'qa', 'Renda dos Artesãos', 'Os artesãos egípcios obtinham renda produzindo joias, móveis elaborados e estátuas decorativas para venda à nobreza e templos.', 'Como os artesãos egípcios obtinham renda?', 'Produzindo joias, móveis e estátuas para venda', '["Trabalhando em túmulos sem pagamento", "Lutando em batalhas", "Apenas doando trabalho"]', ARRAY['artesãos', 'joias', 'móveis'], true),

((SELECT id FROM public.eras WHERE slug = 'egito-antigo'), 'finance', 'qa', 'Renda dos Escribas', 'Os escribas ganhavam dinheiro registrando impostos, contratos e documentos oficiais, recebendo pagamento do Estado e de particulares.', 'Como os escribas ganhavam dinheiro?', 'Registrando impostos e documentos e recebendo pagamento', '["Vendendo papiro", "Produzindo vinho", "Construindo templos"]', ARRAY['escribas', 'documentos', 'pagamento'], true),

((SELECT id FROM public.eras WHERE slug = 'egito-antigo'), 'finance', 'qa', 'Lucro dos Pescadores', 'Os pescadores do Nilo lucravam vendendo peixe fresco nos mercados locais, aproveitando a abundância de peixes do rio sagrado.', 'Como os pescadores do Nilo lucravam?', 'Vendendo peixe fresco nos mercados locais', '["Guardando templos", "Construindo embarcações militares", "Produzindo papiro"]', ARRAY['pescadores', 'nilo', 'mercados'], true),

((SELECT id FROM public.eras WHERE slug = 'egito-antigo'), 'finance', 'qa', 'Produtos Lucrativos', 'O papiro, ouro e linho eram os produtos mais lucrativos do comércio egípcio devido à sua qualidade única e demanda internacional.', 'Qual produto era muito lucrativo para o comércio egípcio?', 'Papiro, ouro e linho', '["Sal comum", "Trigo apenas", "Pedras comuns"]', ARRAY['papiro', 'linho', 'produtos-lucrativos'], true),

((SELECT id FROM public.eras WHERE slug = 'egito-antigo'), 'finance', 'qa', 'Transporte de Mercadorias', 'Os comerciantes egípcios transportavam mercadorias principalmente em barcos pelo rio Nilo, aproveitando a corrente natural para lucrar com fretes.', 'Como os comerciantes transportavam mercadorias para lucro?', 'Em barcos pelo Nilo', '["Somente por estradas de areia", "Transportando a pé grandes pedras", "Apenas por terra"]', ARRAY['transporte', 'nilo', 'barcos'], true),

((SELECT id FROM public.eras WHERE slug = 'egito-antigo'), 'finance', 'qa', 'Mineração de Ouro', 'Os trabalhadores em mineração de ouro ganhavam dinheiro recebendo pagamento do Estado egípcio ou dos templos que controlavam as minas.', 'Como os trabalhadores em mineração de ouro ganhavam dinheiro?', 'Recebendo pagamento do Estado ou do templo', '["Apenas comida", "Não recebiam nada", "Somente proteção"]', ARRAY['mineração', 'ouro', 'pagamento'], true),

((SELECT id FROM public.eras WHERE slug = 'egito-antigo'), 'finance', 'qa', 'Artesãos de Templos', 'Os artesãos especializados lucravam em templos produzindo estátuas de deuses e ornamentos religiosos elaborados encomendados pelos sacerdotes.', 'Como os artesãos lucravam em templos?', 'Produzindo estátuas e ornamentos religiosos', '["Lutando em guerras", "Plantando trigo", "Guardando tesouros"]', ARRAY['templos', 'estátuas', 'ornamentos'], true),

-- 💻 ERA DIGITAL - 10 Perguntas sobre Economia/Lucro

((SELECT id FROM public.eras WHERE slug = 'era-digital'), 'finance', 'qa', 'Renda de Influenciadores', 'Os influenciadores digitais ganham dinheiro através de patrocínios de marcas, marketing de afiliados e vendas de produtos próprios para suas audiências.', 'Como os influenciadores digitais ganham dinheiro?', 'Patrocínios, marketing e vendas de produtos', '["Somente com vídeos virais", "Fazendo transmissões públicas", "Apenas com curtidas"]', ARRAY['influenciadores', 'patrocínios', 'marketing'], true),
...
((SELECT id FROM public.eras WHERE slug = 'era-digital'), 'finance', 'qa', 'Lucro do Delivery', 'Aplicativos de delivery obtêm lucro cobrando taxas sobre cada pedido e comissões dos restaurantes parceiros por cada venda realizada.', 'Como aplicativos de delivery obtêm lucro?', 'Taxas sobre pedidos e comissão de restaurantes', '["Apenas anunciando apps", "Distribuindo comida gratuitamente", "Somente com publicidade"]', ARRAY['delivery', 'taxas', 'comissões'], true),
...
((SELECT id FROM public.eras WHERE slug = 'era-digital'), 'finance', 'qa', 'Lucro E-commerce', 'Empresas de e-commerce lucram através das vendas de produtos, taxas de serviço e cobrança de frete dos consumidores finais.', 'Como empresas de e-commerce lucram?', 'Vendas de produtos, taxas de serviço e frete', '["Produzindo aplicativos", "Vendendo espaço publicitário", "Apenas com marketing"]', ARRAY['e-commerce', 'vendas', 'frete'], true),
...
((SELECT id FROM public.eras WHERE slug = 'era-digital'), 'finance', 'qa', 'Capital para Startups', 'Startups digitais obtêm capital através de investimentos de venture capital e campanhas de crowdfunding para financiar crescimento e desenvolvimento.', 'Como startups digitais obtêm capital?', 'Investimentos de venture capital e crowdfunding', '["Apenas vendendo produtos físicos", "Trabalhando sem receita", "Somente com empréstimos bancários"]', ARRAY['startups', 'venture-capital', 'investimento'], true),

((SELECT id FROM public.eras WHERE slug = 'era-digital'), 'finance', 'qa', 'Lucro Publicidade Online', 'Empresas de publicidade online lucram cobrando por clique (CPC), impressões (CPM) e campanhas segmentadas baseadas em dados de usuários.', 'Como empresas de publicidade online lucram?', 'Cobrança por clique, impressões e campanhas segmentadas', '["Apenas com vendas de softwares", "Vendendo equipamentos", "Somente com assinaturas"]', ARRAY['publicidade', 'cpc', 'segmentação'], true),

((SELECT id FROM public.eras WHERE slug = 'era-digital'), 'finance', 'qa', 'Lucro Mobilidade Urbana', 'Aplicativos de mobilidade urbana como Uber geram lucro cobrando taxas sobre corridas e oferecendo serviços adicionais como entrega e fretes.', 'Como aplicativos de mobilidade urbana (ex.: Uber) geram lucro?', 'Taxas sobre corridas e serviços adicionais', '["Apenas marketing", "Produzindo carros", "Somente com publicidade"]', ARRAY['mobilidade', 'uber', 'taxas'], true);
